...
/**
 * title AutoRelativeLayout
 * author heyan
 * time 19-7-10 下午4:24
 * desc 无
 */
public class AutoRelativeLayout extends RelativeLayout implements IAutoDesign {
    /**
     * 设计尺寸
     */
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (params == null)
            newParams = (LayoutParams) generateDefaultLayoutParams();
